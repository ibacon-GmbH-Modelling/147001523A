...
R = load(fullfile('data_AZT_ceriodaphnia','Data_repro_Cdubia_AZT_calibration.txt'));
...
Cw = load(fullfile('data_AZT_ceriodaphnia','Data_exposure_Cdubia_AZT_calibration.txt'));
