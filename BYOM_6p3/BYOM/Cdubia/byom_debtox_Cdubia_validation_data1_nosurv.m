...
glo.saveplt = 4; % save all plots as (1) Matlab figures, (2) JPEG file or (3) PDF (see all_options.txt)
...
[data1,w1,LabelTable1] = data_AZT_Cdubia_validation1_nosurv(TR,opt,1);
...
par.hb   = [1e-3  0 1e-3 0.07 1]; % background hazard rate (d-1)
