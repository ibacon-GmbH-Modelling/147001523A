...
if isfield(par,'N0') % do we have a parameter N0 in the script?
    N0    = par.N0(1); % initial population size, ml
    X0(1) = N0;        % put this parameter in the correct location of the initial vector
end
