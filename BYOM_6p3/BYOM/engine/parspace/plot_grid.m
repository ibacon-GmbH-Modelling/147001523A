function figh = plot_grid(pmat,coll_ok,coll_all,coll_prof_pruned,figh,SETTINGS_OPTIM)

% Usage: figh = plot_grid(pmat,coll_ok,coll_all,coll_prof_pruned,figh,SETTINGS_OPTIM)
%
