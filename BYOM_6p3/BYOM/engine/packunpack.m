function pout = packunpack(sel,par,pmat)

% Usage: pout = packunpack(sel,par,pmat)
%
...
% <glo.spln> is used.
%
%       3) pack 2-column matrix <pmat> into existing structure <par> to <pout>
...
global glo glo2 % field names, set in prelim_checks
